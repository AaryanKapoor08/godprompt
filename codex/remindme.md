...
injection bilkul fucked up hain , phele woh instantly 2-3 baar re-write karta hai kuch kuch and then rukta hai , and then again ek baar fir likhta hain . bilkul chuda hua hai , on the other hand gemma ka injection bilkul sahi hai because its still using the legacy architecture.
